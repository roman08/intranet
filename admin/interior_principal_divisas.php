...
default:
$row= FetchArray(ProcesaQuery("select * from intranet_divisas where id='1';"));
?>
<section>
		<article>
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-md-6">
						 <h3 class="azulMedio">Secciones Principales / Dolar Americano</h3>
					...
					<form action="admin_procesa.php" method="post" enctype="multipart/form-data" class="form-horizontal modImg" id="form_preguntas">
						<div class="col-xs-10 col-xs-offset-1 col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-2" >
							<div class="form-group">
								<label class="col-sm-3 control-label">* Corporativo</label>
								<div class="col-sm-5">
									<input class="form-control" type="text" name="corporativo" id="corporativo" value="<?php echo $row['corporativo'];?>" required>
								</div>
							</div>
                            <div class="form-group">
								<label class="col-sm-3 control-label">* Ventanilla</label>
								<div class="col-sm-5">
									<input class="form-control" type="text" name="ventanilla" id="ventanilla" value="<?php echo $row['ventanilla'];?>" required>
								</div>
							</div>
