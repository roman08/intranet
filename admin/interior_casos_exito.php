...
if(isset($_GET['id_caso'])){ $id_caso=$_GET['id_caso']; } else { $id_caso='';}
switch ($opcion){
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-md-6">
						 <h3 class="azulMedio">Agregar Casos de éxito</h3>
			...
			<div class="container">
              ...
              <div class="form-group">
								...
								<div class="col-sm-5">
									...
									<small>Tamaño de imagen 200 x 200px</small>
								</div>
							</div>
...
<section>
		<article>
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-md-6">
						 <h3 class="azulMedio">Modificar Casos de éxito</h3>
						<!--<p>Registre los datos que a continuación se solicitan</p> -->
					</div>
					<div class="col-xs-12 col-sm-2 col-md-6">
		...
		<article>
			<div class="container">
              ...
              <div class="form-group">
                               ...
                               <?php if($row['imagen']!='' and file_exists('../casos_exito/'.$row['imagen'])){ echo '<img class="imagenNoticiasB" src="../casos_exito/'.$row['imagen'].'" /><br/>'; } else { echo 'Sin Imagen<br/>';}?>
									</div>
              ...
              <!--<div class="form-group">
                        ...
                        <input name="ver" type="hidden" id="ver" value="<?php echo $ver;?>">
                        <input name="id_caso" type="hidden" id="id_caso" value="<?php echo $row['id_caso'];?>">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-8">
						<h3 class="azulMedio">Casos de éxito</h3>
<!-- 						<p>En la siguiente lista usted podrá visualizar las facturas que ha registrado en el sistema y el estatus de las mismas.      </p>
 -->					</div>
					<div class="col-xs-12 col-sm-4">
						...
						<button id="pregunta" class="btn btn-lg btnAzmed bco" onclick="location.href='admin.php?ver=<?php echo $ver;?>&opcion=Nuevo'"><img class="iconUser" src="img/ipreguntas.png" alt="preguntas frecuentes">Agregar Caso de éxito</button>
					</div>
				</div>
				...
				<div id="" class="row">
					<table id="tablePreguntas" class="table table-striped table-responsive tableGeneral">
						...
						if ($inicio!='')
						  ...
						  $total= NumRows(ProcesaQuery("select * from intranet_casos_exito;"));
						...
						if (round($total/$rxp)=='0'){$cantidad_paginas=1;}else{$cantidad_paginas=round($total/$rxp);}
						  ...
						  ?>
							<tr>
							  ...
							  <td><?php if ($contador!=1) {?><a class="link_ver"  href="admin_procesa.php?ver=<? echo $ver?>&orden1=<? echo $row['orden'];?>&orden2=<? echo $row['orden']-1;?>&accion=Ordenar&inicio=<? echo $inicio;?>&id_caso=<?php echo $row['id_caso'];?>"><span class="glyphicon glyphicon-arrow-up naranja" aria-hidden="true" title="Subir"></span></a><?php } ?>
								<?php if ($contador!=$total)  {?><a class="link_ver"  href="admin_procesa.php?ver=<? echo $ver?>&orden1=<? echo $row['orden'];?>&orden2=<? echo $row['orden']+1;?>&accion=Ordenar&inicio=<? echo $inicio;?>&id_caso=<?php echo $row['id_caso'];?>"><span class="glyphicon glyphicon-arrow-down naranja" aria-hidden="true" title="Bajar"></span></a><?php } ?></td>
							  <td>
                                <a class="link_ver link_verA"  href="admin.php?ver=<?php echo $ver;?>&opcion=Modificar&id_caso=<?php echo $row['id_caso'];?>" title="Modificar"><span class="glyphicon glyphicon-pencil naranja" aria-hidden="true" title="Editar"></span></a>
                                <a class="link_ver" href="admin_procesa.php?ver=<?php echo $ver;?>&accion=Eliminar&id_caso=<?php echo $row['id_caso'];?>&inicio=<?php echo $inicio;?>" title="Eliminar"><span class="glyphicon glyphicon-trash naranja" aria-hidden="true" title="Eliminar"></span></a></td>
							</tr>
                            <?php } } else {?>
							<tr>
