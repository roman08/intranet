			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-md-6">
						 <h3 class="azulMedio">Agregar Noticia</h3>
...
<section>
		<article>
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-md-6">
						 <h3 class="azulMedio">Modificar Noticia</h3>
						<!--<p>Registre los datos que a continuación se solicitan</p> -->
					</div>
					<div class="col-xs-12 col-sm-2 col-md-6">
			...
			<div class="container">
				<div class="row">
					<form action="admin_procesa.php" method="post" enctype="multipart/form-data" class="form-horizontal modImg" id="form_preguntas">
						<div class="col-xs-10 col-xs-offset-1 col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-2" >
                            ...
                            <div class="form-group">	
								...
								<div class="col-sm-5">
                                	...
                                	<?php if($row['imagen']!='' and file_exists('../noticias/'.$row['imagen'])){ echo '<img class="imagenNoticiasA" src="../noticias/'.$row['imagen'].'" /><br/>'; } else { echo 'Sin Imagen<br/>';}?>
									</div>
                        ...
                        <input name="ver" type="hidden" id="ver" value="<?php echo $ver;?>">
                        <input name="id_noticia" type="hidden" id="id_noticia" value="<?php echo $row['id_noticia'];?>">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-8">
						<h3 class="azulMedio">Noticias</h3>
<!-- 						<p>En la siguiente lista usted podrá visualizar las facturas que ha registrado en el sistema y el estatus de las mismas.      </p>
 -->					</div>
					<div class="col-xs-12 col-sm-4">
						...
						<button id="pregunta" class="btn btn-lg btnAzmed bco" onclick="location.href='admin.php?ver=<?php echo $ver;?>&opcion=Nuevo'"><img class="iconUser" src="img/ipreguntas.png" alt="preguntas frecuentes">Agregar Noticia</button>
					</div>
				</div>
				...
				<div id="" class="row">
					<table id="tablePreguntas" class="table table-striped table-responsive tableGeneral">
						...
						if ($inicio!='')
						  ...
						  $consulta=ProcesaQuery("select * from intranet_noticias order by registro desc limit $inicio, $rxp;");
						  $total= NumRows(ProcesaQuery("select * from intranet_noticias;"));
						...
						if (round($total/$rxp)=='0'){$cantidad_paginas=1;}else{$cantidad_paginas=round($total/$rxp);}
						  ...
						  ?>
							<tr>
							  ...
							  <td class="centrarCelda"><?php if($row['imagen']!='' and file_exists('../noticias/'.$row['imagen'])){ echo '<img class="imagenNoticias" src="../noticias/'.$row['imagen'].'" width="95" />'; } else { echo 'Sin Imagen';}?></td>
								<td class="centrarCelda"><?php echo $row['titulo'];?></td>
								<td>
                                <a class="link_ver link_verA"  href="admin.php?ver=<?php echo $ver;?>&opcion=Modificar&id_noticia=<?php echo $row['id_noticia'];?>" title="Modificar"><span class="glyphicon glyphicon-pencil naranja" aria-hidden="true" title="Editar"></span></a>
                                <a class="link_ver" href="admin_procesa.php?ver=<?php echo $ver;?>&accion=Eliminar&id_noticia=<?php echo $row['id_noticia'];?>&inicio=<?php echo $inicio;?>" title="Eliminar"><span class="glyphicon glyphicon-trash naranja" aria-hidden="true" title="Eliminar"></span></a></td>
							</tr>
                            <?php } } else {?>
							<tr>
