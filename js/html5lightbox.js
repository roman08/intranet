    ...
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            inst.createMarkup = function() {
                ...
                if (inst.options.stamp) inst.$watermark.html("<a href='" + inst.options.freelink + "' style='text-decoration:none;' title='jQuery Lightbox'><div style='line-height:20px;'>" +
                    "</div></div></a>");
            ...
            inst.showDiv = function(elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function() {
                    ...
                    inst.$image.css({
                        width: sizeObj.w,
                        height: sizeObj.h
                    }).html("<div id='html5lightbox-div' style='display:block;width:100%;height:100%;'></div>").show();
            ...
            inst.showWeb = function(elem) {
                var winWidth = inst.options.isMobile ?
                    Math.max($(window).width(), $(document).width()) : $(window).width();
                var winH = window.innerHeight ? window.innerHeight : $(window).height();
                var dataW = elem[ELEM_WIDTH] ? elem[ELEM_WIDTH] : winWidth;
                var dataH = elem[ELEM_HEIGHT] ? elem[ELEM_HEIGHT] : winH - inst.options.navheight;
                var sizeObj = inst.calcElemSize({
            ...
            inst.resizeWindow = function() {
                ...
                var elemW = inst.currentElem[ELEM_WIDTH] ?
                    inst.currentElem[ELEM_WIDTH] : 960;
        ...
        $.fn.lightboxHTML5VideoControls = function(skinFolder, parentInst, hidecontrols, hideplaybutton, defaultvolume) {
            ...
            $videoBtnPause.css({
                ...
                "background-image": "url('" +
                    skinFolder + "html5boxplayer_playpause.png" + "')",
            ...
            if (!isIPhone && ($videoObj.get(0).requestFullscreen ||
