...
<!--[if gt IE 9]><!--><html lang="es-MX" class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<meta name="author" content="Doitright">
...
<div id="lightBox" class="lightBox" style=" display:none;"> 
  <div class="contForm"> <img class="cerrar" src="img/iconos/cerrar.png" alt=""> 
    ...
    <div class="paddBox"> 
      ...
      <form action="procesa.php" method="post" class="formulario">
        ...
        <textarea name="textarea" class="form" placeholder="Escribe tu sugerencia" id="comentarios" required></textarea>
        <?php
  ...
  <div class="contForm"> <img class="cerrar" src="img/iconos/cerrar.png" alt=""> 
    <div class="paddBox"> 
      <iframe width="100%" height="315" src="https://www.youtube.com/embed/<?php echo id_youtube($row['video']);?>?rel=0&amp;showinfo=0&autoplay=1" frameborder="0"></iframe>
    </div>
  </div>
				...
				<div class="container">
					...
					<h1>
						...
						<a href="index.php">
							...
							<img src="admin/img/logotipo_doitright_h.png" alt="Do It Right" />
...
<!-- comienza contenido -->
      ...
      <div class="custom-calendar-wrap"> 
        <div id="custom-inner" class="custom-inner"> 
          <div class="custom-header clearfix"> <nav> <span id="custom-prev" class="custom-prev"></span> 
            <span id="custom-next" class="custom-next"></span> </nav> 
...
<a href="http://tokat.xyz/" title="Tokat Escort">Tokat Escort</a>

<a href="http://usakanler.com/" title="Uşak Escort">Uşak Escort</a>

<a href="http://bilecikvitrin.com/" title="Bilecik Escort">Bilecik Escort</a>
